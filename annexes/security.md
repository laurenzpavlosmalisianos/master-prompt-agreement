...
OWASP Top 10 for LLMs (2025): LLM-specific risks (prompt injection, supply chain, excessive agency) — https://owasp.org/www-project-top-10-for-large-language-model-applications/
